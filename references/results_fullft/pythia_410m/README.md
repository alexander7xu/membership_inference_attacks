# Pythia-410M Full-FT Formal Results

This directory is the lightweight, reviewable record for the completed
Pythia-410M SQuAD full fine-tuning and online RMIA experiment.
...
- Original output: `outputs/squad_fullft_rmia/formal/pythia_410m`
